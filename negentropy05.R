...
Ja=function(mu){
	k1*(ex1(mu))^2+k2a*(ex2a(mu)-sqrt(2/pi))^2
...
Jb=function(mu){
	k1*(ex1(mu))^2+k2b*(ex2b(mu)-sqrt(1/2))^2
...
for(mu in 0:1000){
	mu=mu*0.001
	plot(mu,Jk(mu),xlab="mu",ylab="negentropy",xlim=c(0,1),ylim=c(0,2.5),type="p" ,cex= 0.1,)
	par(new=T)
}
...
for(mu in 0:1000){
	mu=mu*0.001
	plot(mu,J(mu),xlab="mu",ylab="negentropy",xlim=c(0,1),ylim=c(0,2.5),type="p",cex=0.5,col="red")
	par(new=T)
}
